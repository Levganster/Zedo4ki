...
export default function RotatingMushroom() {
  return (
    <div className="relative w-24 h-24 md:w-32 md:h-32">
      ...
      {/* Чертежная разметка для 3D области */}
      ...
      {/* Canvas с дополнительными эффектами */}
      <div className="relative z-10 w-full h-full rounded-full overflow-hidden border border-white/5 backdrop-blur-sm">
